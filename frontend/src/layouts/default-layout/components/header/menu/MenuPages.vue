  ...
  <template v-for="(item, i) in MainMenuConfig" :key="i">
    <template v-if="!item.heading">
      <template v-for="(menuItem, j) in item.pages" :key="j">
        <div
          v-if="menuItem.heading && hasAccess(menuItem.access)"
    ...
    <div
      v-if="item.heading && hasAccess(item.access)"
    ...
    >
      ...
      >
        <template v-for="(menuItem, j) in item.pages" :key="j">
          <div
            v-if="menuItem.sectionTitle && hasAccess(menuItem.access)"
          ...
          >
            ...
            >
              <template v-for="(menuItem1, k) in menuItem.sub" :key="k">
                ...
                <div
                  v-if="menuItem1.heading && hasAccess(menuItem1.access)"
                  class="menu-item"
                >
                  <router-link
                    v-if="menuItem1.route"
...
export default defineComponent({
  ...
  setup() {
    ...
    const hasAccess = store.hasAccess;
