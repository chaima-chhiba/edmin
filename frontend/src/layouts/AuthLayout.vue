  ...
  <div class="d-flex flex-column flex-lg-row flex-column-fluid">
    ...
    <div
      ...
      :style="`background-image: url('${getAssetPath(
        'media/misc/18770.jpg'
      )}')`"
    >
      <!--begin::Content-->
      <div class="fixed-top d-flex align-items-center justify-content-center w-100">
        <router-link to="/" class="mb-0 mb-lg-12 text-center">
          <img
              alt="Logo"
              :src="getAssetPath('media/logos/logo_edtrust.png')"
              class="h-70px h-lg-95px mx-auto"
          />
      </router-link>
        <!--end::Logo-->
